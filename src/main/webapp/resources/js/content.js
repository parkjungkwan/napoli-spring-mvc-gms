function contentUI(ctx){
	return '<div id="content"><section class="features-icons bg-light text-center">'
+'      <div class="container">'
+'        <div class="row">'
+'          <div class="col-lg-4">'
...
+'          <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url("'+ctx+'/resources/img/event1.png");"></div>'
...
+'        </div>'
+'        <div class="row no-gutters">'
+'          <div class="col-lg-6 text-white showcase-img" style="background-image: url("'+ctx+'/resources/img/event2.png");"></div>'
